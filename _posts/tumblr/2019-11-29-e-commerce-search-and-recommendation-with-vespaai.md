...
Vespa uses [OpenNLP](https://opennlp.apache.org/) for [linguistic processing](https://docs.vespa.ai/documentation/linguistics.html) like tokenization and stemming with support for multiple languages (as supported by OpenNLP).
