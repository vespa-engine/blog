...
Once the model has been trained in TensorFlow, export the model parameters _(W1,W2,b1,b2)_ to the application folder as Tensors according to the [Vespa Document JSON format](http://docs.vespa.ai/documentation/reference/document-json-format.html).
